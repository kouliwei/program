...
extern void Store_SensorData(void)
{
	...
	Buff_Real[0] = Real_AHRSBuff[18];
	Buff_Real[1] = Real_AHRSBuff[19];
	Buff_Real[2] = Real_AHRSBuff[20];
	Buff_Real[3] = Real_AHRSBuff[21];
	Buff_Real[4] = Real_AHRSBuff[22];
	Buff_Real[5] = Real_AHRSBuff[23];

	Buff_Real[6] = Real_AHRSBuff[6];
	Buff_Real[7] = Real_AHRSBuff[7];
	Buff_Real[8] = Real_AHRSBuff[4];
	Buff_Real[9] = Real_AHRSBuff[5];
	Buff_Real[10] = Real_AHRSBuff[2];
	Buff_Real[11] = Real_AHRSBuff[3];

	Buff_Real[12] = Real_AHRSBuff[28];
	...
	Buff_Real[18] = gl_Dis[0];
	Buff_Real[19] = gl_Dis[1];
